            ...
            <div class="album-review">
                ...
                <div class="review-content">
                    ...
                    <?php if (isset($_SESSION['grouptype']) && $_SESSION['grouptype'] == 0) : ?>
                        <a href="<?= ROOT ?>/artists/edit/<?= $artist->id ?>"><button style="color:beige;width: fit-content; border-radius: 2px;background-color: rgba(36, 0, 70, 0.2); padding: 5px;">EDIT</button></a>
                    <?php endif; ?>

                    <?php if (isset($_SESSION['grouptype']) && $_SESSION['grouptype'] == 0) : ?>
                        <a href="<?= ROOT ?>/artists/delete/<?= $artist->id ?>"><button style="color:beige;width: fit-content; border-radius: 2px;background-color: rgba(36, 0, 70, 0.2); padding: 5px;">DELETE</button></a>
                    <?php endif; ?>
                </div>
            </div>
